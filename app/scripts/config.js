    ...
    function configApp($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $compileProvider, $locationProvider, $httpProvider, $resourceProvider, $analyticsProvider, apiMockProvider, ktSProvider) {
         ...
         */
            ...
            .state('analytics.projects.list.table', {
                url: '?page&status&per_page&institution_id&account_id',
            ...
            .state('analytics.channels.list', {
                abstract: true,
                url: '',
                templateUrl: 'views/analytics/channels/list_layout.html',
                resolve: resolveFactory(['scripts/controllers/channels/kt-channels-ctrl.js']),
            ...
            .state('analytics.channels.list.table', {
                url: '?page&status&per_page',
            ...
            .state('analytics.accounts.list', {
                abstract: true,
                url: '',
                templateUrl: 'views/analytics/accounts/list_layout.html',
                resolve: resolveFactory(['scripts/controllers/accounts/kt-accounts-ctrl.js']),
            ...
            .state('analytics.accounts.list.table', {
                url: '?page&status&per_page',
        ...
        .state('analytics.project.loanPlans', {
            ...
            .state('analytics.project.finance.otherIncome.list', {
                url: '',
                abstract: true,
                templateUrl: 'views/analytics/projects/detail/finance/other_income_list_layout.html',
                resolve: resolveFactory(['scripts/controllers/projects/finance/kt-otherIncomes-ctrl.js']),
            ...
            .state('analytics.project.finance.otherIncome.list.table', {
                url: '?page&per_page',
            ...
            .state('analytics.project.finance.otherIncome.edit', {
                url: '/:otherIncomeID/edit',
                templateUrl: 'views/analytics/projects/detail/finance/other_income_form.html',
                resolve: resolveFactory(['scripts/controllers/projects/finance/kt-otherIncome-edit-ctrl.js']),
            ...
            .state('analytics.project.finance.otherIncome.add', {
                url: '/add',
                templateUrl: 'views/analytics/projects/detail/finance/other_income_form.html',
                resolve: resolveFactory(['scripts/controllers/projects/finance/kt-otherIncome-add-ctrl.js']),
    ...
    angular
        ...
        .run(function($rootScope, $state, $location, $timeout, $http, ktHomeResource, uibPaginationConfig, ktUserService, ktS, CacheFactory) {
            ...
            $rootScope.$on('$stateChangeStart', function(event, toState, toParams) {
                ...
                } else if ($rootScope.user && permit && $.inArray('admin', permit) > -1 && $rootScope.user.role !== 'admin') { // 管理员账户特殊页面
